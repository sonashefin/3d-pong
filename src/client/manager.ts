...
class Pong {
  ...
  public mainLight;
  public scene;
  public level1 = document.getElementById("level1");
  public level2 = document.getElementById("level2 ");
  public level3 = document.getElementById("level3 ");
  public test = document.querySelectorAll<HTMLElement>('.wrapper');
  public level = document.getElementById("level");
  public difficulty;
  ...
  main = () => {
    ...
    var isSideCollision = () => {
      var ballX = ball.position.x,
        halfFieldWidth = tableobj.table_WIDTH / 2;
    ...
    var isBallAlignedWithPaddle = (paddle) => {
      var halfPaddleWidth = paddleobj.PADDLE_WIDTH / 2,
