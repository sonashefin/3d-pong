...
export class Table {
    constructor() {
        ...
        this.table_LENGTH = 2800;
        this.addTable = () => {
            const tableGeometry = new THREE.BoxGeometry(this.table_WIDTH, 5, this.table_LENGTH), tableMaterial = new THREE.MeshLambertMaterial({ color: 0x7CFC00 });
